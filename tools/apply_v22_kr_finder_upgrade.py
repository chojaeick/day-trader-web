...
def main():
    ...
    required_runtime_markers=('V22_KR_FULL_ORDER_AUTHORITY','V22_KR_CAPITAL_ALLOCATOR','_v22_kr_exit(row,st)')
    for runtime_marker in required_runtime_markers:
        if runtime_marker not in text:
            raise SystemExit('ABORT required runtime marker missing: '+runtime_marker)
