...
def patch_broker() -> None:
    ...
    # Idempotency: a fully patched file needs no further mutation.
...
def patch_engine() -> None:
    ...
    # Add process sync flag to current one-line constructor without assuming the
    # older GitHub main copy is authoritative.
    ...
    # Emergency stop must be evaluated whenever in_pos, not only when
    # Williams structural EXIT_READY is already true.
